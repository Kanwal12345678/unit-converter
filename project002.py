...
def main():
    ...
    with st.sidebar:
        st.title("About")
        st.info("This unit converter app allows you to effortlessly convert between various units of measurement, making it quick and easy to get accurate results.")
        ...
        st.markdown("1. Pick the conversion type")
        st.markdown("2. Select the input unit")
        st.markdown("3. Enter the value")
        st.markdown("4. Choose the output unit")
        st.markdown("5. Hit 'Convert' to see the result")
        ...
        if theme == "Dark":
            ...
            accent_color = "#1ABC9C"
            gradient = "linear-gradient(135deg, #2980B9 0%, #D5DBDB 100%)"
        elif theme == "Green":
            ...
            container_color = "#ffffff"
            accent_color = "#1ABC9C"
            gradient = "linear-gradient(135deg, #27AE60 0%, #A9DFBF 100%)"
        elif theme == "Gradient":
            ...
            container_color = "#ffffff"
            accent_color = "#F39C12"
            gradient = "linear-gradient(135deg, #8E44AD 0%, #F4ECF7 100%)"
        else:  # Light theme
            primary_color = "#2C3E50"
            secondary_color = "#ECF0F1"
            ...
            container_color = "#ffffff"
            accent_color = "#3498DB"
            gradient = "linear-gradient(135deg, #2C3E50 0%, #F4F6F7 100%)"
